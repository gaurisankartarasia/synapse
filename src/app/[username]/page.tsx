...
import { ProfileHeader } from "../../components/Username/ProfileHeader";
import { FollowStats } from "../../components/Username/FollowStats";
import { FollowButton } from "../../components/Username/FollowButton";
import EnhancedModalList from "../../components/Username/ModalList";
...
import MutualFollowers from "../../components/Username/MutualFollowers";
...
{profileData.uid !== authUser?.uid &&  <MutualFollowers
      ...
      <div className="flex justify-center gap-2">
        ...
        {profileData.uid === authUser?.uid ? (
          <Button variant="outlined" onClick={goToSettingsPage}>
            Settings
          </Button>
        ) : (
