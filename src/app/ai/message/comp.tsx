...
//             <div className="max-w-3xl px-4 py-2 rounded-lg bg-background border rounded-bl-none">
//               <div className="flex items-center space-x-2">
//                 <div className="w-2 h-2 rounded-full animate-pulse"></div>
//                 <div className="w-2 h-2 rounded-full animate-pulse" style={{ animationDelay: '0.2s' }}></div>
//                 <div className="w-2 h-2 rounded-full animate-pulse" style={{ animationDelay: '0.4s' }}></div>
//               </div>
//             </div>
//           </div>
//         )}
...
const GeminiChat: React.FC = () => {
  ...
  return (
    <div className="flex flex-col max-w-5xl mx-auto min-h-screen bg-background">
      {/* Header */}
      <div className="border-b p-4 shadow-sm sticky top-0 z-50 bg-background ">
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-semibold ">AI</h1>
          <div className="flex items-center space-x-2">
      ...
      <ScrollArea ref={chatContainerRef} className="flex-1 p-4 space-y-4">
        {chatHistory.length === 0 ? (
          ...
          chatHistory.map((message) => (
            <div
              ...
              className={`flex ${message.isUser ? 'justify-end' : 'justify-start'}`}
            >
              <Card className={`max-w-3xl ${message.isUser ? 'bg-blue-500 text-white rounded-br-none' : 'bg-card border rounded-bl-none'}`}>
                <CardContent>
                  <div className="whitespace-pre-wrap">{message.text}</div>
        ...
        {loading && (
          <div className="flex justify-start">
            <Card className="max-w-3xl border rounded-bl-none">
              <CardContent>
                <div className="flex items-center space-x-2">
        ...
        {error && (
          <div className="flex justify-center">
            <Card className="max-w-3xl bg-destructive/10 border border-destructive text-destructive">
              <CardContent>
                Error: {error}
              </CardContent>
            </Card>
      ...
      {/* Input Area - Fixed at Bottom */}
      <div className="border-t p-4 bottom-0 sticky max-w-5xl mx-auto w-full rounded-xl bg-background ">
        <form onSubmit={handleSubmit} className="flex space-x-2">
          <Input
            ref={inputRef}
            type="text"
