...
//             const filename = `applications/<span class="math-inline">\{jobId\}/</span>{payload.uid}-<span class="math-inline">\{timestamp\}\-</span>{resume.name}`;
...
//             resumeUrl = `https://storage.googleapis.com/<span class="math-inline">\{bucket\.name\}/</span>{filename}`;
//         }
