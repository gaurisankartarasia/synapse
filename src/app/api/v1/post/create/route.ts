...
//  // app/api/v1/post/create/route.ts
...
//     const { content, imageURLs, hashtags, allowCommenting } = body;
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Increment media_count in the user's document
    const userRef = db.collection("users").doc(creator_uid);
