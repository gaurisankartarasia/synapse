  ...
  useEffect(() => {
    ...
    const fetchPostData = async () => {
      try {
        ...
        const response = await axiosInstance.get(`/post/${id}/query`);
        ...
        if (axios.isAxiosError(error)) {
          console.error('Axios error fetching post data:', error.response?.data || error.message);
        } else {
    ...
    const handleLike = async () => {
      ...
      try {
        ...
        await axiosInstance.post('/post/like', { postId: id });
      } catch (error) {
        if (axios.isAxiosError(error)) {
    ...
    const handleSave = async () => {
      ...
      try {
        ...
        await axiosInstance.post('/post/save', { postId: id });
      } catch (error) {
        if (axios.isAxiosError(error)) {
    ...
    const handleDelete = async () => {
      ...
      try {
        ...
        if (axios.isAxiosError(error)) {
          console.error("Axios error deleting post:", error.response?.data || error.message);
        } else {
          console.error("Unexpected error:", error);
        }
        alert("Failed to delete post.");
    ...
    const handleReport = async (reason: string) => {
      ...
      try {
        ...
        await axiosInstance.post(`/post/${post.id}/report`, { reason });
    
        alert("Report submitted successfully!");
      } catch (error) {
        if (axios.isAxiosError(error)) {
          console.error("Axios error reporting post:", error.response?.data || error.message);
        } else {
          console.error("Unexpected error:", error);
        }
        alert("Failed to report post.");
