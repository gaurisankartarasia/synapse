...
// const uploadImages = async (images: File[], userToken: string): Promise<string[]> => {
//   const uploadedImageURLs = [];
...
//       // First upload images
//       const uploadedImageURLs = await uploadImages(images, userToken);
      
//       // Then create post with the uploaded image URLs
