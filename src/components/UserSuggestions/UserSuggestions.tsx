...
//       // Update local suggestions state to reflect the change
//       setSuggestions(prev =>
//         prev.map(user =>
//           user.username === username
//             ? {
//                 ...user,
//                 isFollowing: !followState.followStatus[username]?.isFollowing,
//                 isRequested: followState.followStatus[username]?.isRequested || false,
//               }
//             : user
//         )
//       );
